...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Catch blocks catch redirects in Next.js, so we do nothing here.
    }
  };

  return (
    <div className="absolute inset-0 flex items-center justify-center bg-brand-black p-4 z-50">
      <div style={{ width: '448px', maxWidth: '90vw' }} className="bg-bento-card border border-brand-silver/10 rounded-2xl p-8 relative overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.5)]">
        {/* Glow effect */}
        ...
        <div className="text-center mb-8 relative z-10">
          ...
          <p className="font-body-md text-brand-silver">Log in to manage your institutional edge.</p>
        </div>
